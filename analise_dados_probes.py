...
def plot_latency_hops_by_country_individual(df, output_dir):
    ...
    for service in services:
        ...
        plt.title(f'Quantidade de Saltos por País para {service}', fontsize=16)
        plt.legend(title="País", bbox_to_anchor=(1.05, 1), loc='upper left')
        plt.tight_layout()
...
def plot_latency_hops_by_continent_individual(df, output_dir):
    ...
    for service in services:
        ...
        plt.xlabel('Tempo')
        plt.ylabel('Quantidade de Saltos')
        plt.title(f'Quantidade de Saltos por Continente para {service}', fontsize=16)
        plt.legend(title="Continente", bbox_to_anchor=(1.05, 1), loc='upper left')
        plt.tight_layout()
...
def plot_avg_latency_hops_by_site(df, output_dir):
    ...
    plt.title('Quantidade Média de Saltos por Site', fontsize=16)
    plt.tight_layout()
